...
namespace Wcf.Calculadora
{
    ...
    public class MiCalculadora : IMiCalculadora
    {
       ...
       public Numero RealizarOperadorBinaria(char elOperador, Numero elPrimerNumero, Numero elSegundoNumero)
        {
        ...
        public Numero RealizarOperadorBinario(char elOperador, Numero elPrimerNumero, Numero elSegundoNumero)
